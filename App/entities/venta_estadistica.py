...
class VentaEstadistica:
    def __init__(self, id_venta: int = None, tipo_documento: str = None, numero_documento: str = None,
                 id_usuario: int = None, nom_usuario: str = None, documento_cliente: str = None,
                 nombre_cliente: str = None, total_pagar: float = None, pago_con: float = None,
                 cambio: float = None, fecha_registro: datetime = None):
